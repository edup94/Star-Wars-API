...
router.post('/favPlanets/:userid/:planetid', verifyToken, utils_1.safe(actions.addFavPlanet));
router["delete"]('/favPlanets/:userid/:planetid', verifyToken, utils_1.safe(actions.deleteFavPlanet));
router.post('/favCharacters/:userid/:characterid', verifyToken, utils_1.safe(actions.addFavPeople));
router["delete"]('/favCharacters/:userid/:characterid', verifyToken, utils_1.safe(actions.deleteFavPeople));
